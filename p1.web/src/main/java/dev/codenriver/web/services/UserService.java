...
public interface UserService {
     ...
     */
    public boolean logIn(String username, String password, User userClass) throws SQLException, IllegalAccessException;

    /**
     * Retrieves all of the currently available messages in the application.
     * @return a list of the available messages
     */
    public ArrayList<Object> viewAllMessages() throws SQLException, ClassNotFoundException, InvocationTargetException, InstantiationException, IllegalAccessException;
     ...
     */
    public Message getMessage(int id) throws SQLException, IllegalAccessException;
     ...
     */
    public User getUser(int id) throws SQLException, IllegalAccessException;
